...
let funItems = ["Go to beach", "Buy snacks at store", "go rock climbing", "go snorkeling"];

let weekendItems = ["clean house inside", "wash outside windows with windex", "bleach shower", "finish ICS 360 homework", "finish ICS projects"];
...
res.render("list", {listTitle: "Fun Items To-Do List", 
...
res.render("list", {listTitle: "Weekend Items To-Do List", 
